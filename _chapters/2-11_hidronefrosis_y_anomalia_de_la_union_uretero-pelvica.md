...
**Figura 1:** _Imagen de ultrasonido prenatal de un riñón displásico multiquístico en un feto de mitad de gestación. Los marcadores indican la longitud renal (71 mm). Nótese los múltiples quistes de gran tamaño entre el parénquima ecogénico, que parecen no comunicante en un examen de ultrasonido meticuloso._‬
...
![](RackMultipart20210723-4-k354el_html_d4737e14ae7a30f.gif)‬
...
- función decreciente en el riñón dilatado (15-17,64),‬
- aumento de la dilatación pélvica (15-17,64),‬
- dilatación pélvica moderada (\&gt; 20 mm) con dilatación de los cálices (15,22),‬
...
La obstrucción persistente o recurrente puede ser el resultado de la formación de una estenosis o un colgajo en la anastomosis, que puede reflejar una anastomosis colocada demasiado alta en la pelvis renal. Ocasionalmente, una anomalía UPJ coexistente no diagnosticada con antelación sólo se vuelve aparente después de la pieloplastia **(Figura 6)**. La ureteropielografía puede ser necesaria para diagnosticar con precisión la formación de estenosis en la UPJ o para identificar una anomalía UPJ coexistente. Se puede considerar la dilatación y colocación de stents en el segmento estenótico, aunque algunos niños requerirán una reoperación o reimplante ureteral después de la escisión de la anomalía UPJ en el futuro. Las tasas de reoperación para la pieloplastia son típicamente 3-5% (1).‬
