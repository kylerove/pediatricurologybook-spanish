...
‭  1. Falla renal conocida.‬
‭  2. Deshidratación‬
‭  3. Efecto sinérgico junto a otros fármacos nefrotóxicos.‬
‭4. Toxicidad cardiovascular – Arritmia debido a aumento de la actividad vagal.‬
...
‭ • Niño de 6 -12 años: 300 microgramos IM (0,3 ml)‬
‭ • Niño menor de 6 años: 150 microgramos IM (0,15 ml)‬
...
‭  1. Historia e investigaciones de sangre.‬
‭  2. Medir la creatinina sérica‬
‭2. Precauciones previas‬

‭  1. Considere una imagen alternativa si está &quot;en riesgo&quot;‬
‭  2. Detener las drogas tóxicas renales.‬
‭  3. Administración de hidratación previa y posterior al contraste (consultar las directrices locales)‬
‭  4. Utilice medios de contraste de peso osmolar bajo‬
...
‭Hallazgos (Figura 5 a)‬

‭Grado I: reflujo en uréter no dilatado‬
‭ Grado II: reflujo hasta la pelvis renal y cálices sin dilatación‬
‭ Grado III - dilatación leve / moderada del uréter, pelvis renal y cálices con preservación de los fornix (Fig. 5b)‬
...
‭Figura 5a Grado radiológico del RVU.‬
‭ ![Figura 5](/assets/figures/figure-1-3-5.png)‬

‭Fig. 5b: reflujo de grado 3;‬
...
‭  - Cicatrices renales y lesiones renales. (Fig. 6)‬
...
‭Fig. 6: DMSA en un paciente con doble sistema recolector derecho. Se observa cicatrización significativa y función reducida en el polo inferior y un polo superior no funcional.‬
...
‭Fig. 7: Obstrucción de la unión de la PU izquierda, con aumento de la acumulación del isótopo radioactivo a lo largo del tiempo, lo que sugiere un sistema obstruido.‬
...
‭La IVU (por sus siglas en ingles) es un estudio funcional que depende de la captación de contraste por el parénquima renal y la excreción de éste. Las imágenes transversales han disminuido el uso de la IVU en la población pediátrica. La ecografía puede revelar inicialmente la mayoría de los detalles anatómicos necesarios para las decisiones de manejo, sin el uso de radiación o el riesgo de contraste intravenoso.‬
‭ Aunque está siendo cada vez menos utilizado, la IVU es utilizada para:‬

‭  - Evaluación de uréter ectópico o megauréteres que se dilaten a nivel de la vejiga‬
‭  - Evaluación de la anatomía del sistema caliceal para la planificación de LPC (Fig. 8 a, b)‬

‭Fig. 8 a, b: Radiografía simple que muestra múltiples cálculos en el riñón derecho. IVU ayuda como una hoja de ruta para identificar el cáliz afectado y así planificar el mejor enfoque terapéutico.‬
...
‭3. Caracterizar la anatomía y la relación de los órgano adyacentes con las lesiones, como en el caso de tumor de Wilms o un neuroblastoma (Fig. 9 a, b)‬
...
‭ Fig. 9a, b: Gran masa que compromete riñón derecho con múltiples depósitos metastásicos pulmonares.‬
...
‭  1. Etapificación de los cánceres‬
‭  2. Sospecha de masa renal‬
‭  3. Selección de pacientes con enfermedad de Von Hippel-Lindau‬
‭  4. Sospecha de obstrucción del tracto renal‬
‭2. Urografía por RM‬

‭  1. Dos técnicas comunes‬
...
‭1. Angiografía RM renal: como alternativa a la angiografía convencional y la angiografía por TC‬
...
‭  1. Se debe reservar para pacientes en los que no es posible un drenaje retrógrado.‬
‭  2. Se debe evaluar el riesgo de hemorragia e infección previo al procedimiento‬
‭  3. Cobertura antibiótica‬
‭  4. Guiado por ultrasonido, fluoroscopía o TC.‬
‭  5. Complicaciones‬
...
‭1. NLP- Nefrolitotomía percutánea‬

‭  1. Reservado para pacientes que no son candidatos para ureteroscopía o litotripsia por ondas de choque.‬
‭  2. Procedimiento en 2 pasos‬
...
‭4. Pollack HM, ed. _Clinical Urography_. Philadelphia, Pa: WB Saunders and Co; 2000.‬
‭5. Fotter, R. _Pediatric Uroradiology_. Berlin: Springer; 2001.‬
...
‭8. Carty H. _Imaging Children_. Edinburgh: Elsevier; 2005.‬
‭9. de Bruyn, R. _Pediatric Ultrasound: How, Why, and When_. Edinburgh: Elsevier; 2005.‬
‭10. Swischuk, LE. _Imaging of the Newborn, Infant, and Young Child_. Baltimore, Md: Lippincott, Williams &amp; Wilkins; 2004.‬
